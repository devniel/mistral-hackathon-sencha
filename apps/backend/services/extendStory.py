...
def extendStory(story, number_words, language="english"):
    ...
    chat_response = client.chat(
        ...
        """Extend the following story : '''{content} ''' in less than {number_words} words. Make it captivating and intriguing without giving away spoilers. Focus on conveying the style, main conflict, and unique elements that make the story stand out. Ensure the extended story entices readers to want to read the full story. The story should be in {language}.""".format(
